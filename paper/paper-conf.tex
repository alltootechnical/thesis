...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/secure_eigenfaces.png}
...
\begin{itemize}
	...
	\item The DGK and Dasgupta--Pal cryptosystem are implemented from scratch.
\end{itemize}
...
\end{align*}
Partial sums of the above infinite series can be calculated based on the closed form approximation for the logarithm in Equation \ref{eq:scaledquadraturech3}. For the implementation of the power-law transformation, the first six terms of the infinite series were used.
...
The results shown here are gathered from the tests for intensity transformations under Paillier and Dasgupta--Pal cryptosystems. During testing, the Pyfhel library being used for the BGV cryptosystem is still 
...
\begin{table}[h]
    ...
    \begin{tabular}{lcccccc}
        ...
        \texttt{anpage} & 0.000 & $\infty$ & 1.00000 & 0.084 & 0.010 & 0.016 \\
		\texttt{bplyce} & 0.000 & $\infty$ & 1.00000 & 0.063 & 0.008 & 0.016 \\
		\texttt{drbost} & 0.000 & $\infty$ & 1.00000 & 0.062 & 0.008 & 0.016 \\
		\texttt{ksunth} & 0.000 & $\infty$ & 1.00000 & 0.077 & 0.010 & 0.017 \\
		\texttt{martin} & 0.000 & $\infty$ & 1.00000 & 0.067 & 0.008 & 0.023 \\
		\texttt{pmives} & 0.000 & $\infty$ & 1.00000 & 0.060 & 0.008 & 0.016 \\
		\texttt{rnpwil} & 0.000 & $\infty$ & 1.00000 & 0.061 & 0.008 & 0.030 \\
		\texttt{sbains} & 0.000 & $\infty$ & 1.00000 & 0.061 & 0.008 & 0.033 \\
		\texttt{swewin} & 0.000 & $\infty$ & 1.00000 & 0.072 & 0.008 & 0.016 \\
		\texttt{yfhsie} & 0.000 & $\infty$ & 1.00000 & 0.062 & 0.008 & 0.016 \\
		\bottomrule
        \end{tabular}
\end{table}
\begin{table}[h]
    ...
    \begin{tabular}{lcccccc}
        \toprule
        Image & MSE  & PSNR & SSIM & $t_\text{enc}$ & $t_\text{apply}$ & $t_\text{dec}$ \\ \midrule
        \texttt{anpage} & 13.143 & 36.944 & 0.99311 & 0.073 & 1.238 & 0.016 \\
		\texttt{bplyce} & 6.870 & 39.761 & 0.99038 & 0.061 & 1.324 & 0.016 \\
		\texttt{drbost} & 8.019 & 39.089 & 0.98642 & 0.061 & 1.284 & 0.016 \\
		\texttt{ksunth} & 25.194 & 34.118 & 0.98944 & 0.065 & 1.318 & 0.042 \\
		\texttt{martin} & 10.148 & 38.067 & 0.98744 & 0.078 & 1.271 & 0.023 \\
		\texttt{pmives} & 2.404 & 44.322 & 0.99420 & 0.056 & 1.384 & 0.021 \\
		\texttt{rnpwil} & 5.087 & 41.067 & 0.98968 & 0.071 & 1.322 & 0.016 \\
		\texttt{sbains} & 16.762 & 35.888 & 0.98512 & 0.058 & 1.338 & 0.016 \\
		\texttt{swewin} & 5.686 & 40.583 & 0.99360 & 0.067 & 1.360 & 0.016 \\
		\texttt{yfhsie} & 12.135 & 37.290 & 0.99383 & 0.057 & 1.293 & 0.017 \\
		\bottomrule
        \end{tabular}
\end{table}
\begin{table}[h]
    ...
    \begin{tabular}{lcccccc}
        \toprule
        Image & MSE  & PSNR & SSIM & $t_\text{enc}$ & $t_\text{apply}$ & $t_\text{dec}$ \\ \midrule
        \texttt{anpage} & 4264.991 & 11.832 & 0.35971 & 0.058 & 12.800 & 0.016 \\
		\texttt{bplyce} & 881.611 & 18.678 & 0.87174 & 0.056 & 13.017 & 0.021 \\
		\texttt{drbost} & 1166.789 & 17.461 & 0.83118 & 0.072 & 12.462 & 0.018 \\
		\texttt{ksunth} & 648.512 & 20.012 & 0.91254 & 0.071 & 12.667 & 0.037 \\
		\texttt{martin} & 541.318 & 20.796 & 0.90277 & 0.069 & 12.515 & 0.018 \\
		\texttt{pmives} & 1933.216 & 15.268 & 0.65838 & 0.060 & 12.957 & 0.016 \\
		\texttt{rnpwil} & 728.828 & 19.505 & 0.87270 & 0.064 & 13.752 & 0.016 \\
		\texttt{sbains} & 617.591 & 20.224 & 0.91169 & 0.079 & 12.578 & 0.016 \\
		\texttt{swewin} & 7985.854 & 9.108 & 0.45367 & 0.074 & 12.884 & 0.016 \\
		\texttt{yfhsie} & 2114.705 & 14.878 & 0.60351 & 0.076 & 13.625 & 0.016 \\
		\bottomrule
        \end{tabular}
\end{table}
\begin{table}[h]
    ...
    \begin{tabular}{lcccccc}
        \toprule
        Image & MSE  & PSNR & SSIM & $t_\text{enc}$ & $t_\text{apply}$ & $t_\text{dec}$ \\ \midrule
		\texttt{anpage} & 0.000 & $\infty$ & 1.00000 & 0.150 & 22.523 & 0.152 \\
		\texttt{bplyce} & 0.000 & $\infty$ & 1.00000 & 0.258 & 21.940 & 0.265 \\
		\texttt{drbost} & 0.000 & $\infty$ & 1.00000 & 0.172 & 22.164 & 0.207 \\
		\texttt{ksunth} & 0.000 & $\infty$ & 1.00000 & 0.222 & 20.952 & 0.156 \\
		\texttt{martin} & 0.000 & $\infty$ & 1.00000 & 0.145 & 28.285 & 0.181 \\
		\texttt{pmives} & 0.000 & $\infty$ & 1.00000 & 0.181 & 21.873 & 0.169 \\
		\texttt{rnpwil} & 0.000 & $\infty$ & 1.00000 & 0.175 & 22.408 & 0.235 \\
		\texttt{sbains} & 0.000 & $\infty$ & 1.00000 & 0.158 & 22.312 & 0.273 \\
		\texttt{swewin} & 0.000 & $\infty$ & 1.00000 & 0.255 & 27.705 & 0.225 \\
		\texttt{yfhsie} & 0.000 & $\infty$ & 1.00000 & 0.289 & 26.008 & 0.185 \\		
		\bottomrule
        \end{tabular}
\end{table}
