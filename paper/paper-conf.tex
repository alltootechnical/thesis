...
\section{Methodology}
In this study we apply three homomorphic encryption schemes~\cite{ziad_cryptoimg:_2016, pieprzyk_efficient_2007, garay_algorithms_2014} for use in image processing and facial recognition applications.
...
For convenience, a wrapper library is created that integrates the three cryptosystems into a unified interface.

\subsection{Extension of Partially Homomorphic Cryptosystems}
