...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}
		...
		\legend{Original quadrature, Scaled quadrature}
		\end{semilogyaxis}
	\end{tikzpicture}%
...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}
		...
		\legend{Partial sum of Euler's series, Gauss--Legendre quadrature}
		\end{semilogyaxis}
	\end{tikzpicture}%
	\caption{Comparison of inverse tangent approximation errors under Paillier over the interval $[-1, 1]$}
	\label{fig:comp_arctan}
\end{figure}

% \subsection{Timing Results}
% Timing data was based on a laptop computer with a 2.5 GHz Intel Core i7 quad-core processor and 8 GB of RAM.
