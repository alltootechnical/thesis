...
\FirstThesisAdviser{MARLENE M. DE LEON, Ph.D.}
...
%\input{parts/08_appendices_a_introductionandsampleguidequestions}
%\chapter{THESIS FORMATTING GUIDELINES}
%\input{parts/08_appendices_b_thesisformattingguidelines}
%\end{appendices}
