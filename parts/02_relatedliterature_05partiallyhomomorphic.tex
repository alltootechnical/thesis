...
%insert background
The DGK cryptosystem was published by Damgard, Geisler, and Krøigaard in an effort to create a secure integer comparison scheme \cite{pieprzyk_efficient_2007, cryptoeprint:2008:321}. It encrypts  It is widely used in the literature %insert citations here
\subsubsection{Key Generation}
