...
In cryptography, a cryptosystem consists of an encryption function $\mathcal{E}$, a decryption function $\mathcal{D}$.
...
In image processing, the typical image operations being done are intensity transformations which maps intensity values to another, using spatial filters to do operations such as edge detection and image blurring, and histogram processing and equalization. 
...
\subsection{Histogram Processing and Equalization}
\textbf{TO-DO}
