...
\ThesisTitle{IMPLEMENTATION AND ANALYSIS OF HOMOMORPHIC FACIAL IMAGE ENCRYPTION AND MANIPULATION}
...
\input{parts/08_appendices_b_numericalapproximations_updated}
\chapter{ACCEPTED PAPERS}
The following pages include related papers accepted in the following conferences.
\begin{itemize}
    \item 19th Philippine Computing Science Congress (PCSC 2019)
    \item 2019 4th International Conference on Multimedia Systems and Signal Processing (ICMSSP 2019)
\end{itemize}
\end{appendices}
